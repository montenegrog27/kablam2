...
//         localStorage.setItem("currentCashSessionId", existingSession.id);
//         localStorage.setItem("currentCashRegisterId", selectedRegister.id);
...
//     localStorage.setItem("currentCashSessionId", newSession.id);
//     localStorage.setItem("currentCashRegisterId", selectedRegister.id);
